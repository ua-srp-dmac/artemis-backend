    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replicate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artemis.replicate')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artemis.site')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(blank=True, max_length=31, null=True)),
                ('latitude', models.FloatField()),
                ('longitude', models.FloatField()),
                ('plot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='artemis.plot')),
                ('site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='artemis.site')),
            ],
        ),
    ]
